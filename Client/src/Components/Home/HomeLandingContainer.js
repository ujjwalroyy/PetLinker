...
import girlHoldingADog from "./images/home.png";
import homepageDog from "./images/img16.png";
    ...
    <div className="home-container">
      <div className="homeContainer-left">
        ...
        <div className="adopt-btn">
          <Link to='./pets'><button className="Home-button" onClick={scrollToTop}><p>Adopt</p><img src={footPrint} alt="footprint" /></button></Link>
        </div>
      </div>
